    ...
    <el-card>
      ...
      <el-table :data="tableData" v-loading="loading" border>
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button link type="success" :disabled="row.status === 1" @click="handleAudit(row, 1)">通过</el-button>
            <el-button link type="danger" :disabled="row.status === 0" @click="handleAudit(row, 0)">拒绝</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { auditInstitution, getAuditList } from '@/api/platform'
