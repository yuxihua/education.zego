...
export const studentMyRecordings = (params) => studentClient.get('/student/my-recordings', { params })
export const studentCourseRecordings = (courseId) => studentClient.get(`/student/course/${courseId}/recordings`)
export const studentGetRecordingProgress = (params) => studentClient.get('/student/recording-progress', { params })
